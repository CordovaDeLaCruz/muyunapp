...
export const VALIDATORS: any = {
    builtInValidators: {
        ...
        pattern: {
            hours: {
                validatorPattern: '(([0-9]|0[0-9]|1[0-9]|2[0-3]):[0-5][0-9])',
                inputPattern: '[0-9\\:]',
                msg: 'Sólo números para las horas.'
            },
            positiveDigits: {
                validatorPattern: '\\d',
                inputPattern: '\\d',
            ...
            decimalPercentages: {
                ...
                inputPattern: '[0-9\\.]',
                msg: 'Sólo números para el porcentaje según formato.'
            },
            alfanumerics: {
            ...
            alfanumericsSpace: {
                ...
                msg: 'Caracteres alfanumérico. Espacios sólo serán permitidos después de una palabra.'
            },
            letters: {
                validatorPattern: '([a-zA-Zá-úÁ-Ú]+( +[.a-zA-Zá-úÁ-Ú]+)*$)',
                inputPattern: '[.a-zA-Zá-úÁ-Ú ]',
                msg: 'Sólo letras. Espacios sólo serán permitidos después de una palabra'
            },
            digitos: {
            ...
            cellPhone: {
                ...
                inputPattern: '\\d',
                msg: 'Sólo formato Celular (9 Digitos exactamente).'
            },
            lettersNoSpace: {
    ...
    customValidators: {
        ...
        equalTo: { // para otros inputs (ngModel)
            ...
            msg: 'Debe coincidir con el campo contraseña'
        },
        equal: {
        ...
        max: {
            msg: 'Sólo números menores o igual a X.'
        },
        minDate: {
            msg: 'Sólo fechas superiores a X.'
        },
        min: {
            msg: 'Sólo números mayores o igual a X.'
        },
...
export class ValidatorsMessagesComponent implements OnInit {
  ...
  //#region getters
    ...
    getValidationMessage(_controlVar: any): string {
  ...
  setValidationMessageCondition(_controlVar: any, _ngDirty?: boolean, _ngTouched?: boolean): boolean {
      // puse la condicion de undefined
